...
export const getSkinAnalysis = async (userId: string): Promise<SkinAnalysisResult | null> => {
...
export const submitSkinAnalysis = async (userId: string, imageUrl: string): Promise<{ id: string } | null> => {
  const supabase = createClient();
